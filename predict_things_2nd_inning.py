...
joblib.dump(regressor_bat, './pkl/2st_inn_bat_win_wicket.pkl')

import pickle
with open('./pkl/2st_inn_bat_win_hot.pkl', 'wb') as pickle_file:
...
from sklearn.externals import joblib
joblib.dump(regressor_bowl, './pkl/2st_inn_bowl_win_run.pkl')

import pickle
with open('./pkl/2st_inn_bowl_win_hot.pkl', 'wb') as pickle_file:
...
print(ans)
from sklearn.externals import joblib
joblib.dump(regressor, './pkl/2st_inn_end.pkl')

import pickle
with open('./pkl/2st_inn_end_hot.pkl', 'wb') as pickle_file:
