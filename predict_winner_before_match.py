...
onehotencoder = OneHotEncoder(categorical_features = [0,1,2,3], handle_unknown = "ignore")
...
joblib.dump(regressor, './pkl/pre_pred.pkl')

import pickle
with open('./pkl/pre_hot.pkl', 'wb') as pickle_file:
